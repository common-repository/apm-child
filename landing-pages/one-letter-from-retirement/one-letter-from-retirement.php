...
<head>
    ...
    <title>One Letter From Retirement</title>
    <link rel="stylesheet" href="<?php echo APM_PLUGIN_PATH ?>landing-pages/one-letter-from-retirement/assets/bootstrap/css/bootstrap.min.css">
    ...
    <link rel="stylesheet" href="<?php echo APM_PLUGIN_PATH ?>landing-pages/one-letter-from-retirement/assets/css/styles.css">
</head>
...
<body>
    <section class="d-lg-flex d-xl-flex d-xxl-flex justify-content-center align-items-center align-items-lg-center align-items-xl-center align-items-xxl-center" id="section1">
        <div class="container d-flex flex-column align-items-center align-items-xxl-center" id="container1">
            <div class="d-xxl-flex flex-column justify-content-center align-items-center align-content-center justify-content-xxl-center align-items-xxl-center" id="top-container" style="width: 100%;">
                <p class="fw-normal" id="text-top"><strong>Some Positive News For Unprecedented Times...</strong></p>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-5" style="text-align:center;"><img id="nick-kate" src="<?php echo APM_PLUGIN_PATH ?>landing-pages/one-letter-from-retirement/assets/img/nick-kate.png"></div>
                <div class="col-md-6 col-lg-7 align-self-center">
                    <h1 id="headline">You Could Be Just&nbsp;<span style="text-decoration: underline; color: rgb(14, 48, 69);">One Simple Letter</span> Away From The End Of All Your Financial Worries...</h1>
                </div>
            </div>
            <p class="fw-semibold" id="text-bottom">... And If You <span style="text-decoration: underline;">Enter Your Email Address Below</span> <br>I Can Show You Exactly How To Write It!</p>
            <div class="row d-xl-flex justify-content-xl-center" id="form-container">
                <div class="col align-self-center" style="width: 100%;">
						...
						<script>
                            function onSubmitFormolfr1(event) {
                                event.preventDefault();
                        
                                
                                if(document.getElementById('frm_subscribers_olfr1').elements['subscriber_first_name'].value == "")
                                {
                                ...
                                var emailaddr = document.getElementById('frm_subscribers_olfr1').elements['subscriber_email'].value;
                                ...
                                grecaptcha.ready(function() {
                                    grecaptcha.execute('<?php echo __($recaptcha_site_key, 'apm-child')?>', {action: 'submit'}).then(function(token) {
                                        ...
                                        document.getElementById('frm_subscribers_olfr1').elements['recaptcha_token'].value = token;
                                        // Submit the form
                                        document.getElementById('frm_subscribers_olfr1').submit();
                                    });
                                });
                                
                                /* Disable the Submit Button after clicking and enable the Loader*/
                                var submitButton = document.getElementById("btnApmSubmitolfr1");
                                submitButton.disabled = true;
                                
                                /* Enable the Loader*/
                                var hiddenDiv = document.querySelector(".progress_olfr1");
                        ...
                        <form name="frm_subscribers" class="frm_subscribers" id="frm_subscribers_olfr1" method="post" action="https://affiliatepromembership.com/mi_email_subscribers.php">
                        ...
                        <input type="hidden" name="form_name" value="one-letter-from-retirement">
                       ...
                       <input type="hidden" name="apm_aweber_tag" value="<?php echo apm_display_aweber_tag('one-letter-from-retirement');?>">
                        ...
                        <center><input type="submit" name="submit-om" class="om-trigger-conversion plf-submit-button" id="btnApmSubmitolfr1" onclick="onSubmitFormolfr1(event)" value="Access The Special Report Now..."></center>
                        
                        <div class="progress progress_olfr1"></div>
                        <br>
    ...
    <script src="<?php echo APM_PLUGIN_PATH ?>landing-pages/one-letter-from-retirement/assets/bootstrap/js/bootstrap.min.js"></script>
</body>
