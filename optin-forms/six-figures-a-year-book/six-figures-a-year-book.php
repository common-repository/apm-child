...
?>
    ...
    <link rel="stylesheet" href="<?php echo APM_PLUGIN_PATH ?>optin-forms/six-figures-a-year-book/Six-Figures-A-Year.css" media="screen">     
    ...
    <div class="inline-container-inner">
        <div class="inline-row row-optin-landing-1 pt-4 pb-4">
            <div class="inline-col-lg-5 optin-aling-center">
                <img class="u-image u-image-contain u-image-default u-image-1" src="<?php echo APM_PLUGIN_PATH ?>optin-forms/six-figures-a-year-book//images/book.png" alt="" data-image-width="906" data-image-height="1126">
            </div>
            <div class="inline-col-lg-7">
                <h1 class="u-custom-font u-align-center u-font-montserrat u-text u-text-black u-text-default u-title u-text-1"> Author offers a&nbsp;<span style="text-decoration: underline !important;">FREE</span>&nbsp;copy of this book to his next door neighbor... to prove he's not a drug dealer!
                </h1>
            </div> 
        </div>
        ...
        <div class="inline-row">
            <div class="inline-container landing-bg-color-white padding-10">
                <h1 class="u-custom-font u-font-montserrat u-text u-text-custom-color-2 u-title u-text-2"> Now claim your <span>FREE</span> COPY.</h1>
                <p class="u-custom-font u-font-montserrat u-text u-text-black u-text-3"> and follow the step-by-step instructions for making the kind of money (and living the kind of lifestyle) that'll get your neighbors curtains twitching with curiosity!<br>
                </p>
            </div>
        </div>
        
        <div class="inline-row pt-4">
            <p class="u-align-center u-custom-font u-font-montserrat u-text u-text-grey-90 u-text-4"> Enter your details below to discover how to claim your&nbsp;<span style="font-weight: 700; font-style: italic;">FREE COPY of 'Six Figures A Year In Info Publishing'</span>&nbsp;...<br>
            </p>
        </div>
         ...
         <script>
                            function onSubmitFormsfay2(event) {
                               
							   
							    event.preventDefault();
                        
                                
                                if(document.getElementById('frm_subscribers_sfay2').elements['subscriber_first_name'].value == "")
                                {
                                ...
                                var emailaddr = document.getElementById('frm_subscribers_sfay2').elements['subscriber_email'].value;
                                ...
                                grecaptcha.ready(function() {
                                    grecaptcha.execute('<?php echo __($recaptcha_site_key, 'apm-child')?>', {action: 'submit'}).then(function(token) {
                                        ...
                                        document.getElementById('frm_subscribers_sfay2').elements['recaptcha_token'].value = token;
                                        // Submit the form
                                        document.getElementById('frm_subscribers_sfay2').submit();
                                    });
                                });
                                
                                /* Disable the Submit Button after clicking and enable the Loader*/
                                var submitButton = document.getElementById("btnApmSubmitsfay2");
                                submitButton.disabled = true;
                                
                                /* Enable the Loader*/
                                var hiddenDiv = document.querySelector(".progress_sfay2");
			...
			@keyframes progress-p43u5e {
			   100% {
				  background-size: 100% 100%;
                    ...
                    <form name="frm_subscribers" class="frm_subscribers" id="frm_subscribers_sfay2" method="post" action="https://affiliatepromembership.com/mi_email_subscribers.php">
                       ...
                       <div class="optin-inline-form-container">
                        ...
                        <center><input type="submit" name="submit-om" class="om-trigger-conversion plf-submit-button" id="btnApmSubmitsfay2" onclick="onSubmitFormsfay2(event)" value="Access The Special Report Now..."></center>
                        
                        <div class="progress progress_sfay2"></div>
                        <br>
