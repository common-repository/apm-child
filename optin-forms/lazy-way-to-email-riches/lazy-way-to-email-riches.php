...
?>
    ...
    <link rel="stylesheet" href="<?php echo APM_PLUGIN_PATH ?>optin-forms/lazy-way-to-email-riches/lwer.css" media="screen">
    ...
    <div class="inline-container-inner">
		...
		<div class="inline-row row-optin-landing-1 pt-4 pb-4">
            <div class="inline-col-lg-5 optin-aling-center">
                <img class="u-image u-image-contain u-image-default u-image-1" src="<?php echo APM_PLUGIN_PATH ?>optin-forms/lazy-way-to-email-riches/images/nick-kate.png" alt="" data-image-width="906" data-image-height="auto">
            </div>
            <div class="inline-col-lg-7">
                <h1 class="u-custom-font u-align-center u-font-montserrat u-text u-text-black u-text-default u-title u-text-1"> Can You Click Send?
                </h1>
            </div> 
        </div>
		
		<div class="inline-row pt-4">
            <p class="u-align-center u-custom-font u-font-montserrat u-text u-text-grey-90 u-text-4"> “If You Can, Enter Your Details Below And I’ll Show You How To Make A Life-Changing $8,000+ <br>
              A Month From Home…&nbsp;<br>
            </p>
        </div>
     	...
     	<div class="inline-row pt-4">
        				 ...
        				 <script>
                            function onSubmitForm(event) {
                                ...
                                if(document.getElementById('frm_subscribers_').elements['subscriber_first_name'].value == "")
                                {
                                ...
                                var emailaddr = document.getElementById('frm_subscribers_').elements['subscriber_email'].value;
                                ...
                                grecaptcha.ready(function() {
                                    grecaptcha.execute('<?php echo __($recaptcha_site_key, 'apm-child')?>', {action: 'submit'}).then(function(token) {
                                        ...
                                        document.getElementById('frm_subscribers_').elements['recaptcha_token'].value = token;
                                        // Submit the form
                                        document.getElementById('frm_subscribers_').submit();
                                    });
                                });
                                
                                /* Disable the Submit Button after clicking and enable the Loader*/
                                var submitButton = document.getElementById("btnApmSubmit");
                                submitButton.disabled = true;
                                
                                /* Enable the Loader*/
                                var hiddenDiv = document.querySelector(".progress_");
                    ...
                    <form name="frm_subscribers" class="frm_subscribers" id="frm_subscribers_" method="post" action="https://affiliatepromembership.com/mi_email_subscribers.php">
                       ...
                       <div class="optin-inline-form-container">
                        ...
                        <center><input type="submit" name="submit-om" class="om-trigger-conversion plf-submit-button" id="btnApmSubmit" onclick="onSubmitForm(event)" value="Discover His Proven Formula"></center>
                        
                        <div class="progress progress_"></div>
                        <br>
