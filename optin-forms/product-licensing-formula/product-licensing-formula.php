...
?>
    <link rel="stylesheet" href="<?php echo APM_PLUGIN_PATH ?>optin-forms/product-licensing-formula/plf.css" media="screen">
  ...
  <section class="inline-container u-section-1 d-flex flex-column align-items-center align-items-xxl-center">
    <div class="inline-container-inner">
		...
		<div class="inline-row pt-4">
            <p class="u-align-center u-custom-font u-font-montserrat u-text u-text-grey-90 u-text-4"> What This Guy Stumbled Across By Accident Nearly <u>TWENTY YEARS AGO</u> Is Anything But Average.<br>
            </p>
        </div>
		
        <div class="inline-row row-optin-landing-1 pt-4 pb-4">
            <div class="inline-col-lg-5 optin-aling-center">
                <img class="u-image u-image-contain u-image-default u-image-1" src="<?php echo APM_PLUGIN_PATH ?>optin-forms/product-licensing-formula//images/nick-kate.png" alt="" data-image-width="906" data-image-height="auto">
            </div>
            <div class="inline-col-lg-7">
                <h1 class="u-custom-font u-align-center u-font-montserrat u-text u-text-black u-text-default u-title u-text-1"> It's Still Banking Him <span style="color:#FAC51C;">$25,000 - $35,000</span> EVERY SINGLE MONTH!
                </h1>
            </div> 
        </div>
         ...
         <div class="inline-row pt-4">
        				 ...
        				 <script>
                            function onSubmitFormplf2(event) {
                               
							   
							    event.preventDefault();
                        
                                
                                if(document.getElementById('frm_subscribers_plf2').elements['subscriber_first_name'].value == "")
                                {
                                ...
                                var emailaddr = document.getElementById('frm_subscribers_plf2').elements['subscriber_email'].value;
                                ...
                                grecaptcha.ready(function() {
                                    grecaptcha.execute('<?php echo __($recaptcha_site_key, 'apm-child')?>', {action: 'submit'}).then(function(token) {
                                        ...
                                        document.getElementById('frm_subscribers_plf2').elements['recaptcha_token'].value = token;
                                        // Submit the form
                                        document.getElementById('frm_subscribers_plf2').submit();
                                    });
                                });
                                
                                /* Disable the Submit Button after clicking and enable the Loader*/
                                var submitButton = document.getElementById("btnApmSubmitplf2");
                                submitButton.disabled = true;
                                
                                /* Enable the Loader*/
                                var hiddenDiv = document.querySelector(".progress_plf2");
                    ...
                    <form name="frm_subscribers" class="frm_subscribers" id="frm_subscribers_plf2" method="post" action="https://affiliatepromembership.com/mi_email_subscribers.php">
                       ...
                       <div class="optin-inline-form-container">
                        ...
                        <center><input type="submit" name="submit-om" class="om-trigger-conversion plf-submit-button" id="btnApmSubmitplf2" onclick="onSubmitFormplf2(event)" value="Discover His Proven Formula..."></center>
                        
                        <div class="progress progress_plf2"></div>
                        <br>
