...
?>
<link rel="stylesheet" href="<?php echo APM_PLUGIN_PATH ?>optin-forms/serious-about-six-figures/sasf.css" media="screen">
    ...
    <div class="inline-container-inner">
        ...
        <div class="inline-row row-optin-landing-1 pt-4 pb-4">
            <div class="inline-col-lg-5 optin-aling-center">
                <img class="u-image u-image-contain u-image-default u-image-1" src="<?php echo APM_PLUGIN_PATH ?>optin-forms/serious-about-six-figures/images//book-and-player-transformed.png" alt="" data-image-width="906" data-image-height="1126">
            </div>
            <div class="inline-col-lg-7">
                    ...
                    <form name="frm_subscribers" class="frm_subscribers" id="frm_subscribers_sasf2" method="post" action="https://affiliatepromembership.com/mi_email_subscribers.php">
                       ...
                       <div class="optin-inline-form-container">
                        ...
                        <center><input type="submit" name="submit-om" class="om-trigger-conversion plf-submit-button" id="btnApmSubmitsasf2" onclick="onSubmitFormsasf2(event)" value="Yes! Tell Me More"></center>
